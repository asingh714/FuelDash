    ...
    <div className="terms-of-use-page">
      ...
      <div className="terms-of-use-content">
        <nav>
          ...
          <ul>
            <li>
              <a href="#welcome">Welcome to FuelDash</a>
            </li>
            <li>
        ...
        <main>
          <section id="welcome">
            ...
            <p>
              ...
              independent gas station owners. These Terms of Use
              (&quot;Terms&quot;) govern your access to and use of our services,
              including our various websites, APIs, email notifications,
              applications, buttons, widgets, ads, and other covered services
              (the &quot;Services&quot;).
            </p>
          </section>
          ...
          <section id="modifications">
            <h2>Modifications</h2>
            <p>
              FuelDash Inc. reserves the right to modify or replace these Terms
          ...
          <section id="user-registration">
            ...
            <p>
              To use FuelDash, you may be required to register for an account.
          ...
          <section id="disclaimer">
            ...
            <p>
              The Services are provided &quot;as-is.&quot; FuelDash Inc.
          ...
          <section id="governing-law">
            ...
            <p>
              ...
              FuelDash Inc. is registered, without respect to its conflict of
              laws principles.
            </p>
          </section>
        </main>
